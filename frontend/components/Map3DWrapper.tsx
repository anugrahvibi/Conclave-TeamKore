...
const Map3D = dynamic(() => import('./Map3D'), {
  ssr: false,
  loading: () => (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', width: '100vw', background: '#ffffff', color: '#0f172a', fontFamily: 'system-ui, sans-serif' }}>
