...
export default function Home() {
  return (
    <main className="min-h-screen w-full bg-white p-1 md:p-2 flex flex-col items-center justify-center">
      <div className="w-full h-[calc(100vh-0.5rem)] md:h-[calc(100vh-1rem)] rounded-[4rem] [corner-shape:squircle] overflow-hidden border border-gray-200 relative bg-white">
        <Map3DWrapper
